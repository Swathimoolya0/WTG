...
TRIG = 16 								#Trigger pin of the Ultrasonic Sensor 
ECHO = 18								#Echo pin of the Ultrasonic Sensor
...
def sensor_data(d,o):
    msg=vehicle.message_factory.distance_sensor_encode(0,5,250,d,0,1,o,0,)
